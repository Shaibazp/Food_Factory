...
//                        'pdfHtml5'
    ...
    <body>
                            ...
                            <nav class="navbar navbar-default" id="mainNav">
                                ...
                                <div id="navbar" class="navbar-collapse collapse">
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li class="active"><a href="view_orders.jsp">View Orders</a></li>
        ...
        <table id="example" class="display" style="width:100%">
            ...
            <tbody>
                <%
                    PreparedStatement pstn = con.prepareStatement("select oo.dishname, oo.price, oo.qnt, oo.tableNo, cc.custName, cc.cdate from orderdetail oo join customerdetail cc on oo.mobile = cc.custMobile");

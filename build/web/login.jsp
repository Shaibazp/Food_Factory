                            ...
                            <nav class="navbar navbar-default" id="mainNav">
                                ...
                                <div id="navbar" class="navbar-collapse collapse">
                                    <ul class="nav navbar-nav navbar-right">
                                        <li ><a href="food_login.jsp">Home</a></li>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form action="login_validate.jsp" method="post">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-box">
                                        <input type="text" name="username" id="form_name" placeholder="Name" required="required" data-error="Username is required.">
                                    </div>
                                </div>
                                <!-- end col -->
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-box">
                                        <input type="password" name="password"  placeholder="Password" required="required" data-error="Password is required.">
                                    </div>
                                </div>
                                <!-- end col -->

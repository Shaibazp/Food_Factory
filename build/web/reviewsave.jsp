            ...
            <div class="container">
                <div class="row">
                    <div class="form-reservations-box">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <form  method="post" action="savereview.jsp">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-box">
                                        <input type="text" name="dishName" id="form_name" placeholder="Dish Name" value="<%=request.getParameter("dname") %>" readonly>
                                    </div>
                                </div>

                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-box">
                                        <select name="rating" id="Food_Category" class="selectpicker">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" cols="30" rows="7" placeholder="Add Comment here" name="commentt"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="reserve-book-btn text-center">
                                        <input type="submit"  value="Add Review" class="btn btn-primary" style="height: 60px;width: 150px;font-size: 20px;font-weight: bold;">
                                    </div>
                                </div>
                            </form>
                        </div>

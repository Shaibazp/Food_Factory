                ...
                <div class="row">
                    <div class="form-reservations-box">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form  method="post" action="updatefood.jsp">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-box">
                                        <select name="dishName" id="Dish_Name" class="selectpicker">

                                            <option selected disabled> Dish Name</option>
                                            <%                                                try {
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="reserve-book-btn text-center">
                                        <input type="submit"  value="Update Menu Details" class="btn btn-primary">
                                    </div>
                                </div>
                            </form>
                        </div>

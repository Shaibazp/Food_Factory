                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form  method="post" action="deleteStaff.jsp">
                                ...
                                <!--                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                         ...
                                                         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-box">
                                                                    <input type="number" name="salary" id="phone" placeholder="Salary">
                                                                </div>
                                                            </div>
                                                             end col 
                                                     ...
                                                     <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <textarea class="form-control" cols="30" rows="7" placeholder="Employee Details" name="info"></textarea>
                                                                            </div>
                                                                        </div>
                                                             end col -->
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="reserve-book-btn text-center">
                                        <input type="submit"  value="Delete Staff Details" class="btn btn-primary">
                                    </div>
                                </div>

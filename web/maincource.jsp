...
<body>
   ...
   <div id="banner" class="banner1 full-screen-mode parallax" style="height: 25px;">
    ...
    <!-- end banner -->
    <div id="blog" class="blog-main pad-top-50 pad-bottom-100 parallax">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="blog-box clearfix">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="blog-block">
                                    <div class="blog-img-box">
                                        <img src="Imagess/Main Dish/South Indian Main Dish.webp" alt="" style="height: 220px;" />
                                        <div class="overlay">
                        ...
                        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <div class="col-md-6 col-sm-6">
                                <div class="blog-block">
                                    <div class="blog-img-box">
                                        <img src="Imagess/Main Dish/North Main Dish.png" alt="" style="height: 220px;" />
                                        <div class="overlay">
                                            <a href=""><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <div class="col-md-6 col-sm-6">
                                <div class="blog-block">
                                    <div class="blog-img-box">
                                        <img src="Imagess/Main Dish/Maharashtra Main.jpg" alt="" style="height: 220px;"/>
                                        <div class="overlay">
                                            <a href=""><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
                                    </div>

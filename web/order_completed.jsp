...
//                        'pdfHtml5'
    ...
    <body>
                            ...
                            <nav class="navbar navbar-default" id="mainNav">
                                ...
                                <div id="navbar" class="navbar-collapse collapse">
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li class="active"><a href="order_completed.jsp">Completed Order</a></li>
        ...
        <table id="example" class="display" style="width:100%">
            ...
            <tbody>
                <%
                    PreparedStatement pstn = con.prepareStatement("SELECT distinct * FROM food_factory.orderdetail ordtl  join food_factory.customerdetail cdtl ON ordtl.mobile = cdtl.custMobile where order_status=1 order by oid asc");
